	...
	<body class="nav-md">
								...
								<div class="x_panel">
									<div class="x_title">
										...
										<ul class="nav navbar-right panel_toolbox">
											<li><a href="<?=base_url('dashboard/collection?favorite=1');?>"><button class="btn btn-default" type="button"><span><i class="fa fa-star"></i> &nbsp;Favorite</span></button></a></li>
											<li><a href="<?=base_url('dashboard/collection');?>"><button class="btn btn-default" type="button"><span><i class="fa fa-bars"></i> &nbsp;All</span></button></a></li>
									...
									<div class="x_content">
										<div class="row">
											...
											<div class="col-md-55">
												<div class="<?php if($c->is_favorite==1){echo 'thumbnail border-gold';} else { echo 'thumbnail';}?>">
													<div class="image view view-first">
														...
														<img style="width: 100%; display: block;" src="<?=(is_null($c->image)?base_url('assets/img/').'Noimage.png':base_url('upload/collection/').substr($c->image, 0, -4).'_250.jpg');?>" alt="image" />
														<div class="mask">
															<div class="tools tools-bottom">
																...
																&nbsp;&nbsp;
																<i class="<?php if($c->is_favorite==1){echo 'fa fa-star color-gold';} else {echo 'fa fa-star';}?>"></i>
															</div>
														</div>
													</div>
													<div class="caption">
		...
		<script type="text/javascript">
			...
			$(".thumbnail .fa-star").click(function(){
				...
				$.ajax({
					type: "POST",
					url: "<?=base_url('dashboard/collection/doFavorite');?>", 
					dataType: 'json',
					data: {id: id},
					success: function(){
			...
			$('#collectionEditButton').click(function(e) {
				...
				$.ajax({
					type: "POST",
					url: "<?=base_url('dashboard/collection/doUpdate');?>", 
					dataType: 'json',
